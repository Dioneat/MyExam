    ...
    class Physics : Constructor
    {
        ...
        public static WrapPanel CreateVariant()
        {
            ...
            for (int i = 0; i < BaseOfTasks.TaskCollection.Count; i++)
            {
                ...
                panel.Children.Add(AddLabel(1760, 30, $"Задание №{i + 1}", FontWeights.Bold, 15)); // Заголовок варианта
                var but = AddButton(30, 30, "", new Thickness(0, 0, 0, 0));
                but.Click += Calc_Click;
        ...
        private static void Calc_Click(object sender, RoutedEventArgs e) => new PhysCalc().ShowDialog();
